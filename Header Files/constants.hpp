...
const extern float EARTH_RADIUS;
const extern float LOWEST_LAT;
const extern float LOWEST_LONG;
const extern float HIGHEST_LAT;
const extern float HIGHEST_LONG;
